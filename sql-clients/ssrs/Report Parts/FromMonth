...
<ComponentItem Name="FromMonth" xmlns="http://schemas.microsoft.com/sqlserver/reporting/2010/01/componentdefinition" xmlns:rdl="http://schemas.microsoft.com/sqlserver/reporting/2016/01/reportdefinition" xmlns:rd="http://schemas.microsoft.com/SQLServer/reporting/reportdesigner">
  <Properties>
...
FROM
  vwNotificationMonth</rdl:CommandText>
      ...
      <rdl:ReportParameters>
        <rdl:ReportParameter Name="FromMonth">
          <rdl:DataType>String</rdl:DataType>
          <rdl:Prompt>*From: Month</rdl:Prompt>
          <rdl:ValidValues>
          ...
          <ComponentMetadata xmlns="http://schemas.microsoft.com/sqlserver/reporting/2010/01/componentdefinition">
            <ComponentId>aa74731c-1a34-4753-89f1-76c07a2ff65a</ComponentId>
            <SourcePath>/Report Parts/FromMonth</SourcePath>
            <SyncDate>2019-01-03T10:17:55.6700000+00:00</SyncDate>
          </ComponentMetadata>
        </rdl:ReportParameter>
      </rdl:ReportParameters>
      ...
      <rd:ReportID>3218431a-5b9b-4f69-a196-6b8f3dced27c</rd:ReportID>
    </rdl:Report>
  </RdlFragment>
</ComponentItem>