...
CREATE PROCEDURE [dbo].[uspSeed] AS
	BEGIN TRY
		...
		VALUES
			...
			'1.1. The source ETS data presented is correct as at {ETS_LAST_REFRESHED}. 
			1.2. The source NTBS data presented is correct as at {NTBS_LAST_REFRESHED}. 
			1.3 The source Cluster data presented is correct as at {CLUSTER_LAST_REFRESHED} .
