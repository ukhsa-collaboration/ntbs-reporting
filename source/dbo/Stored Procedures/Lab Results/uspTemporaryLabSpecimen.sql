...
ALTER PROCEDURE [dbo].[uspTemporaryLabSpecimen] AS
	SET NOCOUNT ON
	...
	BEGIN TRY
		...
		INSERT INTO [dbo].[TemporaryLabSpecimen] VALUES ('M.19.0999911.M', CAST(N'2019-11-12T00:00:00.000' AS DateTime),'Sputum', 'Royal Free Hospital Microbiology', 
			...
			12,'TBS0001', 'Possible', CAST(N'2019-12-02T00:00:00.000' AS DateTime), CAST(N'2019-12-02T00:00:00.000' AS DateTime), 
		...
		INSERT INTO [dbo].[TemporaryLabSpecimen] VALUES ('M.19.0999911.M', CAST(N'2019-11-12T00:00:00.000' AS DateTime),'Sputum', 'Royal Free Hospital Microbiology', 
			'NMRL', 'M. tuberculosis', NULL, CAST(N'1972-01-25T00:00:00.000' AS DateTime), 'POSTCODE, ANTHONY', N'F', NULL, N'LS167QQ', 
			13, 'TBS001','Possible', CAST(N'2019-12-02T00:00:00.000' AS DateTime), CAST(N'2019-12-02T00:00:00.000' AS DateTime), 
		...
		INSERT INTO [dbo].[TemporaryLabSpecimen] VALUES ('H199990028', CAST(N'2019-11-14T00:00:00.000' AS DateTime),'Bronchoscopy sample', 'Luton Microbiology Laboratory', 
			'NMRL', 'M. tuberculosis', '4564561122', CAST(N'1972-01-25T00:00:00.000' AS DateTime), 'CAMPBELL, COLIN', 'M', NULL, N'LS14BY', NULL, 'TBS001',NULL, NULL, NULL,
