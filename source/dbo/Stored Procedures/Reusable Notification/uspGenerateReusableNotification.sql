...
Create PROCEDURE [dbo].[uspGenerateReusableNotification] AS
	...
	BEGIN TRY
		...
		-- Reset
		DELETE FROM dbo.ReusableNotification

		INSERT INTO dbo.ReusableNotification
			SELECT
				-- Primary key
				...
				dbo.ufnGetCountryName(th.TravelledCountryId1)               AS TravelCountry1, 
				dbo.ufnEmptyOrIntValue(th.Travelduration1)                  AS MonthsTravelled1,
				dbo.ufnGetCountryName(th.TravelledCountryId2)               AS TravelCountry2, 
				dbo.ufnEmptyOrIntValue(th.Travelduration2)                  AS MonthsTravelled2,
				dbo.ufnGetCountryName(th.TravelledCountryId3)               AS TravelCountry3, 
				...
				dbo.ufnGetCountryName(th.VisitorCountryId1)                 AS VisitorCountry1, 
				th.Visitduration1                                           AS DaysVisitorsStayed1,
				dbo.ufnGetCountryName(th.VisitorCountryId2)                 AS VisitorCountry2, 
				th.Visitduration1                                           AS DaysVisitorsStayed2,
				dbo.ufnGetCountryName(th.VisitorCountryId3)                 AS VisitorCountry3, 
