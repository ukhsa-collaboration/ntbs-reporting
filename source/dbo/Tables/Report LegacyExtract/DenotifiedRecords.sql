CREATE TABLE [dbo].[DenotifiedRecords](
	-- This primary key
	[DenotifiedRecordId] [int] IDENTITY(1,1) NOT NULL,
	...
	[Denotified] [nvarchar] (3) NULL,
	[DenotificationDate] [date] NULL,
	[DenotificationReason] [nvarchar] (255) NULL,
	...
	[DataRefreshedAt] [datetime] NOT NULL
	 ...
	 CONSTRAINT [PK_DenotifiedRecords] PRIMARY KEY CLUSTERED (
		[DenotifiedRecordId] ASC
	)
) ON [PRIMARY]
GO
